...
if(isset($_POST['name']) and isset($_POST['emaild']) and isset($_POST['phone']) and isset($_POST['message'])){
	$name = $_POST['name'];
	$mail = $_POST['emaild'];
	$phone = $_POST['phone'];
    ...
    if($name == '') {
        ...
        echo json_encode(array('info' => 'error', 'msg' => "Пожалуйста введите коректную почту."));
        exit();
    } else if($phone == ''){
